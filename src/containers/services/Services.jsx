  ...
  <div className="features section__padding" id="services">
    <div className="features-heading">
      <h1 className="gradient__text">
        We will provide services and continue to expand as we strive to be the
        worlds leading resource for builders, investors and communities creating
        the web3.0 games of tomorrow.
      </h1>
      <p></p>
    </div>
